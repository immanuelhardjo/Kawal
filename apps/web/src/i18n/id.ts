...
export const id = {
  ...
  signin: {
    ...
    submitButton: 'Masuk',
    signupLink: 'Belum punya akun? Daftar',
    errorInvalidCredentials: 'Email atau kata sandi salah.',
    errorUnknown: 'Terjadi kesalahan. Coba lagi.',
  },
  signup: {
    title: 'Buat akun Kawal',
    description: 'Daftarkan diri Anda untuk mulai menggunakan Kawal.',
    emailLabel: 'Email',
    passwordLabel: 'Kata sandi',
    passwordHint: 'Minimal 8 karakter, mengandung huruf kapital dan simbol.',
    submitButton: 'Buat akun',
    signinLink: 'Sudah punya akun? Masuk',
    errorEmailTaken: 'Email sudah terdaftar.',
    errorPasswordPolicy: 'Kata sandi tidak memenuhi syarat: minimal 8 karakter, huruf kapital, dan simbol.',
    errorUnknown: 'Terjadi kesalahan. Coba lagi.',
  },
  account: {
    title: 'Akun',
