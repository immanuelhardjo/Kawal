# Capability: Case History Sidebar

## Purpose

Defines the persistent left navigation sidebar rendered in a cork-board material aesthetic, displaying the user's recently explored cases as amber-pinned entries on all authenticated screens at desktop widths.
