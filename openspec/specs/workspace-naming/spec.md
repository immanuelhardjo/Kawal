...
Defines the canonical package names and directory locations for workspace packages within the Kawal monorepo, ensuring consistent naming across pnpm filters, directory structure, and root scripts.
